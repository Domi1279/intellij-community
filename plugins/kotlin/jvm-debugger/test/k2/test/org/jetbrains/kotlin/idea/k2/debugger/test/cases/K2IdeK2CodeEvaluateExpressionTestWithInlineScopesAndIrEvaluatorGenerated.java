...
public abstract class K2IdeK2CodeEvaluateExpressionTestWithInlineScopesAndIrEvaluatorGenerated extends AbstractK2IdeK2CodeEvaluateExpressionTestWithInlineScopesAndIrEvaluator {
    @RunWith(JUnit3RunnerWithInners.class)
    @TestMetadata("../testData/evaluation/singleBreakpoint")
    public abstract static class SingleBreakpoint extends AbstractK2IdeK2CodeEvaluateExpressionTestWithInlineScopesAndIrEvaluator {
        @RunWith(JUnit3RunnerWithInners.class)
        @TestMetadata("../testData/evaluation/singleBreakpoint/compilingEvaluator")
        public abstract static class CompilingEvaluator extends AbstractK2IdeK2CodeEvaluateExpressionTestWithInlineScopesAndIrEvaluator {
            @RunWith(JUnit3RunnerWithInners.class)
            @TestMetadata("../testData/evaluation/singleBreakpoint/compilingEvaluator/inaccessibleMembers")
            public static class InaccessibleMembers extends AbstractK2IdeK2CodeEvaluateExpressionTestWithInlineScopesAndIrEvaluator {
            ...
            @RunWith(JUnit3RunnerWithInners.class)
            @TestMetadata("../testData/evaluation/singleBreakpoint/compilingEvaluator")
            public static class Uncategorized extends AbstractK2IdeK2CodeEvaluateExpressionTestWithInlineScopesAndIrEvaluator {
                private void runTest(String testDataFilePath) throws Exception {
                    KotlinTestUtils.runTest(this::doSingleBreakpointTest, this, TargetBackend.JVM_WITH_IR_EVALUATOR, testDataFilePath);
                }
        ...
        public static class ContextReceivers extends AbstractK2IdeK2CodeEvaluateExpressionTestWithInlineScopesAndIrEvaluator {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest(this::doSingleBreakpointTest, this, TargetBackend.JVM_WITH_IR_EVALUATOR, testDataFilePath);
            }
        ...
        public static class Coroutines extends AbstractK2IdeK2CodeEvaluateExpressionTestWithInlineScopesAndIrEvaluator {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest(this::doSingleBreakpointTest, this, TargetBackend.JVM_WITH_IR_EVALUATOR, testDataFilePath);
            }
        ...
        public static class CreateExpression extends AbstractK2IdeK2CodeEvaluateExpressionTestWithInlineScopesAndIrEvaluator {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest(this::doSingleBreakpointTest, this, TargetBackend.JVM_WITH_IR_EVALUATOR, testDataFilePath);
            }
        ...
        public static class ExtraVariables extends AbstractK2IdeK2CodeEvaluateExpressionTestWithInlineScopesAndIrEvaluator {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest(this::doSingleBreakpointTest, this, TargetBackend.JVM_WITH_IR_EVALUATOR, testDataFilePath);
            }
        ...
        public static class Frame extends AbstractK2IdeK2CodeEvaluateExpressionTestWithInlineScopesAndIrEvaluator {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest(this::doSingleBreakpointTest, this, TargetBackend.JVM_WITH_IR_EVALUATOR, testDataFilePath);
            }
        ...
        public static class FunWithDefaultParam extends AbstractK2IdeK2CodeEvaluateExpressionTestWithInlineScopesAndIrEvaluator {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest(this::doSingleBreakpointTest, this, TargetBackend.JVM_WITH_IR_EVALUATOR, testDataFilePath);
            }
        ...
        public static class ImplicitClassReceiver extends AbstractK2IdeK2CodeEvaluateExpressionTestWithInlineScopesAndIrEvaluator {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest(this::doSingleBreakpointTest, this, TargetBackend.JVM_WITH_IR_EVALUATOR, testDataFilePath);
            }
        ...
        public static class JavaContext extends AbstractK2IdeK2CodeEvaluateExpressionTestWithInlineScopesAndIrEvaluator {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest(this::doSingleBreakpointTest, this, TargetBackend.JVM_WITH_IR_EVALUATOR, testDataFilePath);
            }
        ...
        public static class Labels extends AbstractK2IdeK2CodeEvaluateExpressionTestWithInlineScopesAndIrEvaluator {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest(this::doSingleBreakpointTest, this, TargetBackend.JVM_WITH_IR_EVALUATOR, testDataFilePath);
            }
        ...
        public static class Lambdas extends AbstractK2IdeK2CodeEvaluateExpressionTestWithInlineScopesAndIrEvaluator {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest(this::doSingleBreakpointTest, this, TargetBackend.JVM_WITH_IR_EVALUATOR, testDataFilePath);
            }
        ...
        public static class Renderer extends AbstractK2IdeK2CodeEvaluateExpressionTestWithInlineScopesAndIrEvaluator {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest(this::doSingleBreakpointTest, this, TargetBackend.JVM_WITH_IR_EVALUATOR, testDataFilePath);
            }
        ...
        public static class SimpleConstructors extends AbstractK2IdeK2CodeEvaluateExpressionTestWithInlineScopesAndIrEvaluator {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest(this::doSingleBreakpointTest, this, TargetBackend.JVM_WITH_IR_EVALUATOR, testDataFilePath);
            }
        ...
        public static class SimpleLocals extends AbstractK2IdeK2CodeEvaluateExpressionTestWithInlineScopesAndIrEvaluator {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest(this::doSingleBreakpointTest, this, TargetBackend.JVM_WITH_IR_EVALUATOR, testDataFilePath);
            }
        ...
        public static class SimpleSmartcasts extends AbstractK2IdeK2CodeEvaluateExpressionTestWithInlineScopesAndIrEvaluator {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest(this::doSingleBreakpointTest, this, TargetBackend.JVM_WITH_IR_EVALUATOR, testDataFilePath);
            }
    ...
    public abstract static class MultipleBreakpoints extends AbstractK2IdeK2CodeEvaluateExpressionTestWithInlineScopesAndIrEvaluator {
        @RunWith(JUnit3RunnerWithInners.class)
        @TestMetadata("../testData/evaluation/multipleBreakpoints/library")
        public static class Library extends AbstractK2IdeK2CodeEvaluateExpressionTestWithInlineScopesAndIrEvaluator {
            private void runTest(String testDataFilePath) throws Exception {
